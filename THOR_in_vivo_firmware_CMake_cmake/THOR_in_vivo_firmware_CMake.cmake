...
add_library(slc_THOR_in_vivo_firmware_CMake OBJECT
...
target_include_directories(slc_THOR_in_vivo_firmware_CMake PUBLIC
   "../config"
   "../autogen"
   "../."
    "../ad5940lib"
...
target_compile_definitions(slc_THOR_in_vivo_firmware_CMake PUBLIC
    "DEBUG_EFM=1"
...
target_link_libraries(slc_THOR_in_vivo_firmware_CMake PUBLIC
    "-Wl,--start-group"
    "gcc"
    "c"
    "m"
...
target_compile_options(slc_THOR_in_vivo_firmware_CMake PUBLIC
...
set_property(TARGET slc_THOR_in_vivo_firmware_CMake PROPERTY C_STANDARD 99)
set_property(TARGET slc_THOR_in_vivo_firmware_CMake PROPERTY CXX_STANDARD 11)
set_property(TARGET slc_THOR_in_vivo_firmware_CMake PROPERTY CXX_EXTENSIONS OFF)

target_link_options(slc_THOR_in_vivo_firmware_CMake INTERFACE
    -mcpu=cortex-m33
    -mthumb
    -mfpu=fpv5-sp-d16
    -mfloat-abi=hard
    ...
    --specs=nano.specs
    "SHELL:-Xlinker -Map=$<TARGET_FILE_DIR:THOR_in_vivo_firmware_CMake>/THOR_in_vivo_firmware_CMake.map"
    -Wl,--gc-sections
