# === Simplicity Studio Root Paths ===
# TODO: Modify this accordingly to the dir where Simplicity Studio is installed
set(WIN_SS_PATH "C:/SiliconLabs/SimplicityStudio/v5")
set(MAC_SS_PATH "/Applications/Simplicity Studio.app/Contents/Eclipse")
...
elseif(WIN32)
  set(TOOLCHAIN_DIR "${WIN_SS_PATH}/developer/toolchains/gnu_arm/12.2.rel1_2023.7/bin/")
elseif(APPLE)
  set(TOOLCHAIN_DIR "${MAC_SS_PATH}/developer/toolchains/gnu_arm/12.2.rel1_2023.7/bin/")
else()
...
elseif(WIN32)
  set(POST_BUILD_EXE "${WIN_SS_PATH}/developer/adapter_packs/commander/commander.exe")
elseif(APPLE)
  set(POST_BUILD_EXE "${MAC_SS_PATH}/developer/adapter_packs/commander/Commander.app/Contents/MacOS/commander")
else()
  set(POST_BUILD_EXE "")
endif()
...
elseif(WIN32)
  set(NINJA_RUNTIME_PATH "${WIN_SS_PATH}/developer/adapter_packs/ninja/ninja")
elseif(APPLE)
  set(NINJA_RUNTIME_PATH "${MAC_SS_PATH}/developer/adapter_packs/ninja/ninja")
else()
